...
class Case:
    def __init__(self, name, price, weapon_list = []):
        """
...
def extract_data_from_html(data_string):
...
def get_weapon_data(skin, rarity):
    """ get_weapon_data(skin) compiles a list of the skins of different rarities, wares and prices of a 
    selected skin line
...
def get_weapon_case(case_name):
    ...
    try:
        return Case(case_name, float(price), None)
